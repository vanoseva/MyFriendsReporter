Create  Procedure  [dbo].[sp_getInfoDiscount_forProduct](@m_MinRevenue money,
...
as
		SELECT prl.* 
         ...
         WHERE ls.s_id=pr.s_discount_id and pr.s_ID=prl.s_DiscountDetail_ID and ls.b_Valid=1 and 
            ...
            pr.s_product_ID=@s_Product_ID and prl.m_MinRevenue<=@m_MinRevenue  order by prl.m_MinRevenue desc
