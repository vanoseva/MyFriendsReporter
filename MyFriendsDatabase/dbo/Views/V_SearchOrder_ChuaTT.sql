CREATE view [dbo].[V_SearchOrder_ChuaTT]
as
	select ls.s_ID,ls.s_Order_ID,ls.s_ObjectID as s_Object_ID,o.s_Name as ObjectName,ls.dt_OrderDate as dt_CreateDate,ls.m_OrderTotal as m_Total2,ls.i_TermID as s_Name,N'Chưa thu tiền'as s_Status,  
	...
	WHERE ls.s_ID  not in (select s_NumberID from Pr_NumberIncome)