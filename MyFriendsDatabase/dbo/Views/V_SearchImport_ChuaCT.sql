CREATE view [dbo].[V_SearchImport_ChuaCT]
as
	select ls.s_ID,ls.s_Import_ID as s_Order_ID,ls.s_Object_ID,o.s_Name as ObjectName,ls.dt_ImportDate as dt_CreateDate,ls.m_ImportTotal as m_Total2,ls.PaymentTerm as s_Name,N'Chưa chi tiền'as s_Status,  
	...
	WHERE ls.s_ID not in (select s_NumberID from Pr_NumberOutcome)