CREATE View v_ls_ResOrder      
as      
Select ls.*,e.s_Name as EmpName,t.Name as TableName,        
g.s_ID as GroupID,g.s_Name as GroupName,pr1.Product_ID as ProKey,pr1.ProductID,pr1.Product_Name,pr1.Unit,pr1.Qty,pr1.Price,pr1.Discount,pr1.mDiscount,pr1.IDSort as Ordinal,      
...
from Ls_ResOrder ls 
join PR_ResOrderDetail_NH pr1 on ls.s_ID=pr1.OrderID   
...
pr1.ProName as ProKey,pr1.ProName as ProductID,pr1.ProName as Product_Name,pr1.Unit,pr1.Qty,pr1.Price,pr1.Discount,pr1.mDiscount,pr1.Ordinal,      
...
from Ls_ResOrder ls 
join PR_ResOrderDetail_NH_Ext pr1 on ls.s_ID=pr1.OrderID
left join ls_Employees e on ls.Employee_ID=e.s_ID         
left join ls_Table t on ls.Table_ID=t.s_ID