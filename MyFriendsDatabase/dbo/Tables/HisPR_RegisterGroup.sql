CREATE TABLE [dbo].[HisPR_RegisterGroup] (
    ...
    CONSTRAINT [PK_HisPR_RegisterGroup] PRIMARY KEY CLUSTERED ([s_ID] ASC),
    CONSTRAINT [FK_HisPR_RegisterGroup_PR_Events] FOREIGN KEY ([EventID]) REFERENCES [dbo].[PR_Events] ([s_ID]) ON DELETE CASCADE ON UPDATE CASCADE
);
