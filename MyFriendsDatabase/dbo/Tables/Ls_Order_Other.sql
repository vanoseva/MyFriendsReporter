CREATE TABLE [dbo].[Ls_Order_Other] (
    ...
    [s_ResOrderID]          NVARCHAR (50)   NULL,
    [Curr]                  NVARCHAR (50)   NULL,
    CONSTRAINT [PK_Ls_Order_Orther] PRIMARY KEY CLUSTERED ([s_ID] ASC),
    CONSTRAINT [FK_Ls_Order_Orther_LS_Objects] FOREIGN KEY ([s_ObjectID]) REFERENCES [dbo].[LS_Objects] ([s_ID]) ON DELETE CASCADE ON UPDATE CASCADE
);
