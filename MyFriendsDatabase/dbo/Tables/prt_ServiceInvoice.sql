CREATE TABLE [dbo].[prt_ServiceInvoice] (
    [s_ID]                  NVARCHAR (50)  DEFAULT (newid()) NOT NULL,
    [ServiceTypeInvoice_ID] NVARCHAR (50)  NULL,
    ...
    CONSTRAINT [prt_ServiceInvoice_prt_ServiceTypeInvoice] FOREIGN KEY ([ServiceTypeInvoice_ID]) REFERENCES [dbo].[prt_ServiceTypeInvoice] ([s_ID]) ON DELETE CASCADE ON UPDATE CASCADE
);
