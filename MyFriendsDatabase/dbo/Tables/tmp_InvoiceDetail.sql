CREATE TABLE [dbo].[tmp_InvoiceDetail] (
    ...
    CONSTRAINT [FK_tmp_InvoiceDetail_tmp_Invoices] FOREIGN KEY ([Invoice_ID]) REFERENCES [dbo].[tmp_Invoices] ([s_ID]) ON DELETE CASCADE ON UPDATE CASCADE
);
